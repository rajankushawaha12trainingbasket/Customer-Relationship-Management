           ...
           <div style="width:950px;height:auto;min-height:500px;border-radius:20px;background-color: aquamarine;padding-left:50px;padding-top:25px;">
               <center>
                ...
                <table style="padding-top: 50px; border: 1px; width: 80%;">
                    ...
                    <td style="padding: 10px; border-radius: 5px;color: blue;">Enquiry ID</td> 
                    <td style="padding: 10px; border-radius: 5px;color: blue;">Name</td>
                    <td style="padding: 10px; border-radius: 5px;color: blue;">Enquiry Text</td> 
                   <td style="padding: 10px; border-radius: 5px;color: blue;">Contact No.</td>
                    <td style="padding: 10px; border-radius: 5px;color: blue;">Delete</td>
                     ...
                     <%
                            ...
                            ResultSet rs=c.SelectQuery("select id,name,message,contactno from enquiry ");
                            while(rs.next())
                            {
                            %>
                            <tr>
                                ...
                                <td><a href="code/deleteenquirycode.jsp?id=<%=rs.getInt(1)%>">Delete</a></td>
